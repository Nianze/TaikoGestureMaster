...
always @ (ap_CS_fsm or ap_sig_bdd_31 or tmp_21_fu_33_p1 or ap_return_2_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
...
always @ (ap_CS_fsm or ap_sig_bdd_31 or tmp_21_fu_33_p1 or ap_return_3_preg)
begin
    if (((ap_ST_st1_fsm_0 == ap_CS_fsm) & ~ap_sig_bdd_31)) begin
...
assign tmp_21_fu_33_p1 = p_cols[11:0];
