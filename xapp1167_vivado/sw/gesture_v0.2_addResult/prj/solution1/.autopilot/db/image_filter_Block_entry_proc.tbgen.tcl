set moduleName image_filter_Block_entry_proc
set isCombinational 0
set isDatapathOnly 0
set isPipelined 0
set pipeline_type none
set isOneStateSeq 1
set C_modelName image_filter_Block_entry_proc
set C_modelType { void 0 }
set C_modelArgList { 
	{ return_r int 3 regular {pointer 1 volatile}  }
	{ ges int 3 regular {pointer 0} {global 0}  }
}
