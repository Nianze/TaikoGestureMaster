...
#define XYLONFB_GET_LAYER_COLOR_TRANSP 	XYLONFB_IOR(34, struct xylonfb_layer_color)
#define XYLONFB_SET_LAYER_COLOR_TRANSP 	XYLONFB_IOW(35, struct xylonfb_layer_color)
#define XYLONFB_GET_LAYER_SIZE_POS   	XYLONFB_IOR(36, struct xylonfb_layer_pos_size)
#define XYLONFB_SET_LAYER_SIZE_POS   	XYLONFB_IOW(37, struct xylonfb_layer_pos_size)
...
#define XYLONFB_GET_BACKGROUND_COLOR 	XYLONFB_IOR(42, struct xylonfb_layer_color)
#define XYLONFB_SET_BACKGROUND_COLOR 	XYLONFB_IOW(43, struct xylonfb_layer_color)
#define XYLONFB_LAYER_EXT_BUFF_SWITCH   XYLONFB_IOW(43, unsigned int)
#define XYLONFB_READ_HW_REG 			XYLONFB_IOR(44, struct xylonfb_hw_access)
#define XYLONFB_WRITE_HW_REG 			XYLONFB_IOW(45, struct xylonfb_hw_access)
