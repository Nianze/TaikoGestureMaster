...
(* CORE_GENERATION_INFO="image_filter,hls_ip_2013_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=6.666670,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.520750,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=16,HLS_SYN_DSP=14,HLS_SYN_FF=6234,HLS_SYN_LUT=9258}" *)
...
wire   [1:0] finger_counter_U0_gesture_V_V_din;
wire    finger_counter_U0_gesture_V_V_full_n;
wire    finger_counter_U0_gesture_V_V_write;
...
wire   [1:0] set_color_U0_gesture_V_V_dout;
wire    set_color_U0_gesture_V_V_empty_n;
wire    set_color_U0_gesture_V_V_read;
...
wire    gesture_V_V_ap_dummy_ce;
wire   [1:0] gesture_V_V_din;
wire    gesture_V_V_full_n;
wire    gesture_V_V_write;
wire   [1:0] gesture_V_V_dout;
wire    gesture_V_V_empty_n;
wire    gesture_V_V_read;
...
FIFO_image_filter_gesture_V_V gesture_V_V(
    .clk( ap_clk ),
    .reset( ap_rst ),
...
always @ (ap_sig_ready_src_cols_V_full_n or ap_sig_ready_src_rows_V_full_n or ap_sig_ready_src_rows_V_channel_full_n or ap_sig_ready_src_cols_V_channel_full_n)
begin
    if (((ap_const_logic_1 == ap_sig_ready_src_cols_V_full_n) & (ap_const_logic_1 == ap_sig_ready_src_rows_V_full_n) & (ap_const_logic_1 == ap_sig_ready_src_rows_V_channel_full_n) & (ap_const_logic_1 == ap_sig_ready_src_cols_V_channel_full_n))) begin
...
assign finger_counter_U0_gesture_V_V_full_n = gesture_V_V_full_n;
...
assign gesture_V_V_ap_dummy_ce = ap_const_logic_1;
assign gesture_V_V_din = finger_counter_U0_gesture_V_V_din;
assign gesture_V_V_read = set_color_U0_gesture_V_V_read;
assign gesture_V_V_write = finger_counter_U0_gesture_V_V_write;
...
assign set_color_U0_ap_start = (result1_rows_V_empty_n & result1_cols_V_empty_n);
...
assign set_color_U0_gesture_V_V_dout = gesture_V_V_dout;
assign set_color_U0_gesture_V_V_empty_n = gesture_V_V_empty_n;
