...
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vivado_HLS/2013.2/Linux_x86_64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vivado_HLS/2013.2/Linux_x86_64/tools/opencv:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /opt/xilinx/Vivado_HLS/2013.2/Linux_x86_64/tools/fft_v9_0:$::env(LD_LIBRARY_PATH)
### C sim ###
