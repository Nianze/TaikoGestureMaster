...
create_ip -name floating_point -version 7.0 -vendor xilinx.com -library ip -module_name image_filter_ap_dmul_7_max_dsp
# BEGIN Vivado Commands 
...
set_property -dict [list CONFIG.a_precision_type Double \
                          ...
                          CONFIG.component_name image_filter_ap_dmul_7_max_dsp \
                          ...
                          CONFIG.result_tlast_behv Null] -objects [get_ips image_filter_ap_dmul_7_max_dsp] -quiet
# END Vivado Parameters
generate_target {synthesis} [get_files image_filter_ap_dmul_7_max_dsp.xci]
