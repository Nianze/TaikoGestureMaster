...
set id 43
set name image_filter_dmul_64ns_64ns_64_9_max_dsp
...
set id 44
set name image_filter_dcmp_64ns_64ns_1_3
...
set id 46
set name image_filter_sitodp_64s_64_9
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_gesture_V_V \
    op interface \
    ports { gesture_V_V_din { O 2 vector } gesture_V_V_full_n { I 1 bit } gesture_V_V_write { O 1 bit } } \
} "
}
