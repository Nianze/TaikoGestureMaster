set moduleName finger_counter
set isCombinational 0
set isDatapathOnly 0
set isPipelined 0
set pipeline_type none
set isOneStateSeq 0
set C_modelName finger_counter
...
set C_modelArgList { 
	...
	{ gesture_V_V int 2 regular {fifo 1 volatile}  }
}
...
set portList { 
	...
	{ gesture_V_V_din sc_out sc_lv 2 signal 4 } 
	{ gesture_V_V_full_n sc_in sc_logic 1 signal 4 } 
	{ gesture_V_V_write sc_out sc_logic 1 signal 4 } 
}
...
set Spec2ImplPortList { 
	...
	gesture_V_V { ap_fifo {  { gesture_V_V_din fifo_data 1 2 }  { gesture_V_V_full_n fifo_status 0 1 }  { gesture_V_V_write fifo_update 1 1 } } }
}
