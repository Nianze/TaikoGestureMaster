...
bb.i.0_ifconv:                                    ; preds = %insert_bottom.exit, %bb12
  ...
  %tmp_8 = icmp ugt i13 %tmp_30_cast, %op2_addr_i_i1 ; <i1> [#uses=1]
...
bb56:                                             ; preds = %bb56.preheader, %bb55
  ...
  %tmp_30_cast = zext i11 %t_V to i13             ; <i13> [#uses=2]
  %tmp_3 = icmp ult i13 %tmp_30_cast, %op2_assign_1 ; <i1> [#uses=1]
...
bb.i.0_ifconv:                                    ; preds = %insert_bottom.exit, %bb12
  ...
  %tr = call i8 @_ssdm_op_PartSelect.i8.i11.i32.i32(i11 %t_V, i32 3, i32 10) ; <i8> [#uses=1]
  %icmp = icmp eq i8 %tr, 0                       ; <i1> [#uses=1]
  %tmp_5 = icmp ugt i13 %tmp_30_cast, %op2_addr_i_i1 ; <i1> [#uses=1]
  %tmp2 = or i1 %icmp6, %icmp                     ; <i1> [#uses=1]
...
bb56:                                             ; preds = %bb56.preheader, %bb55
  ...
  %tmp_2 = zext i11 %t_V to i64                   ; <i64> [#uses=9]
  %tmp_30_cast = zext i11 %t_V to i13             ; <i13> [#uses=2]
  %tmp_3 = icmp ult i13 %tmp_30_cast, %op2_assign_2 ; <i1> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 4096, i64 0)
  %j_V = add i11 %t_V, 1                          ; <i11> [#uses=1]
  br i1 %tmp_3, label %bb1, label %bb59
...
bb12_ifconv:                                      ; preds = %bb11, %bb3
  ...
  %temp_V = load i2* @prevGesture_V, align 8      ; <i2> [#uses=1]
  call void @_ssdm_op_FifoWrite.volatile.i2P(i2* %gesture_V_V, i2 %temp_V)
  %tmp_14 = icmp eq i8 %pixel_in_val_5, %prev_load ; <i1> [#uses=4]
  %tmp_26_cast = zext i8 %prevcol_load to i13     ; <i13> [#uses=1]
  %tmp_15 = sub i13 %tmp_17_cast, %tmp_26_cast    ; <i13> [#uses=1]
...
bb27:                                             ; preds = %bb27.preheader, %bb26
  ...
  %tmp_17_cast = zext i12 %t_V_5 to i13           ; <i13> [#uses=2]
  %tmp_6 = icmp ult i13 %tmp_17_cast, %op2_assign_3 ; <i1> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 4096, i64 0)
...
bb38_ifconv:                                      ; preds = %bb37
  ...
  %temp_V_2 = select i1 %tmp_22, i2 %sel_tmp4, i2 0 ; <i2> [#uses=1]
  store i2 %temp_V_2, i2* @prevGesture_V, align 8
  ret void
}
...
bb1_ifconv:                                       ; preds = %bb11
  %tmp_17 = call i32 (...)* @_ssdm_op_SpecRegionBegin([14 x i8]* @p_str45) ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str) nounwind
  %tmp = call i8 @_ssdm_op_FifoRead.volatile.i8P(i8* %src_data_stream_0_V) ; <i8> [#uses=3]
  %tmp_28 = trunc i8 %tmp to i1                   ; <i1> [#uses=2]
  %tmp_V = call i2 @_ssdm_op_FifoRead.volatile.i2P(i2* %gesture_V_V) ; <i2> [#uses=2]
  %tmp_s = icmp eq i8 %tmp, -1                    ; <i1> [#uses=5]
  %tmp_9 = icmp eq i2 %tmp_V, 0                   ; <i1> [#uses=2]
  %tmp_10 = icmp eq i2 %tmp_V, 1                  ; <i1> [#uses=1]
  %sel_tmp = and i1 %tmp_s, %tmp_9                ; <i1> [#uses=2]
  %sel_tmp3 = xor i1 %tmp_9, true                 ; <i1> [#uses=1]
  %tmp2 = and i1 %tmp_10, %sel_tmp3               ; <i1> [#uses=1]
  %sel_tmp5 = and i1 %tmp2, %tmp_s                ; <i1> [#uses=3]
  %tmp_16 = or i1 %sel_tmp5, %sel_tmp             ; <i1> [#uses=1]
  %sel_tmp6 = select i1 %tmp_16, i8 0, i8 %tmp    ; <i8> [#uses=1]
  %pixel_out_val_2 = select i1 %tmp_s, i8 %sel_tmp6, i8 0 ; <i8> [#uses=1]
  %sel_tmp7 = and i1 %sel_tmp5, %tmp_28           ; <i1> [#uses=1]
  %pixel_out_val_1 = and i1 %tmp_s, %sel_tmp7     ; <i1> [#uses=1]
  %pixel_out_val_1_1_cast = sext i1 %pixel_out_val_1 to i8 ; <i8> [#uses=1]
  %sel_tmp8 = and i1 %sel_tmp, %tmp_28            ; <i1> [#uses=1]
  %not_sel_tmp5 = xor i1 %sel_tmp5, true          ; <i1> [#uses=1]
  %sel_tmp9 = and i1 %sel_tmp8, %not_sel_tmp5     ; <i1> [#uses=1]
  %pixel_out_val_0 = and i1 %tmp_s, %sel_tmp9     ; <i1> [#uses=1]
  ...
  %empty_128 = call i32 (...)* @_ssdm_op_SpecRegionEnd([14 x i8]* @p_str45, i32 %tmp_17) ; <i32> [#uses=0]
  br label %bb11

bb11:                                             ; preds = %bb14, %bb1_ifconv
  %t_V = phi i12 [ %j_V, %bb1_ifconv ], [ 0, %bb14 ] ; <i12> [#uses=2]
  %exitcond = icmp eq i12 %t_V, %src_cols_V_read_3 ; <i1> [#uses=1]
  %j_V = add i12 %t_V, 1                          ; <i12> [#uses=1]
  br i1 %exitcond, label %bb14, label %bb1_ifconv

bb14:                                             ; preds = %bb11, %entry
  %t_V_6 = phi i12 [ 0, %entry ], [ %i_V, %bb11 ] ; <i12> [#uses=2]
  %exitcond4 = icmp eq i12 %t_V_6, %src_rows_V_read_3 ; <i1> [#uses=1]
  %i_V = add i12 %t_V_6, 1                        ; <i12> [#uses=1]
  br i1 %exitcond4, label %return, label %bb11
...
bb3:                                              ; preds = %bb14
  ...
  %tmp_18 = call i32 (...)* @_ssdm_op_SpecRegionBegin([13 x i8]* @p_str43) ; <i32> [#uses=1]
  call void (...)* @_ssdm_op_SpecLoopTripCount(i32 0, i32 1920, i32 0, [1 x i8]* @p_str) nounwind
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, [1 x i8]* @p_str) nounwind
  ...
  %empty_138 = call i32 (...)* @_ssdm_op_SpecRegionEnd([13 x i8]* @p_str43, i32 %tmp_18) ; <i32> [#uses=0]
...
!0 = metadata !{i32 462866, i32 0, metadata !1, metadata !"prevGesture.V", metadata !"prevGesture.V", metadata !"prevGesture.V", metadata !4, i32 249, metadata !832, i1 true, i1 true, i2* @prevGesture_V} ; [ DW_TAG_variable_field ]
...
!467 = metadata !{metadata !468, metadata !794, metadata !798, metadata !801, metadata !806, metadata !810, metadata !813, metadata !816, metadata !820, metadata !821, metadata !822, metadata !825, metadata !828, metadata !829}
...
!470 = metadata !{metadata !471, metadata !726, metadata !730, metadata !733, metadata !736, metadata !739, metadata !742, metadata !745, metadata !748, metadata !751, metadata !754, metadata !757, metadata !760, metadata !763, metadata !766, metadata !769, metadata !772, metadata !775, metadata !782, metadata !787, metadata !791}
...
!631 = metadata !{i32 458798, i32 0, metadata !472, metadata !"range", metadata !"range", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE5rangeEii", metadata !21, i32 1883, metadata !632, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!634 = metadata !{i32 458771, metadata !3, metadata !"ap_range_ref<2,false>", metadata !21, i32 872, i64 128, i64 64, i64 0, i32 0, null, metadata !635, i32 0, null} ; [ DW_TAG_structure_type ]
!635 = metadata !{metadata !636, metadata !637, metadata !638, metadata !639, metadata !645, metadata !649, metadata !653, metadata !656, metadata !660, metadata !663, metadata !667, metadata !670, metadata !671, metadata !674, metadata !677, metadata !680, metadata !683, metadata !686, metadata !689, metadata !690}
!636 = metadata !{i32 458765, metadata !634, metadata !"d_bv", metadata !21, i32 873, i64 64, i64 64, i64 0, i32 0, metadata !551} ; [ DW_TAG_member ]
!637 = metadata !{i32 458765, metadata !634, metadata !"l_index", metadata !21, i32 874, i64 32, i64 32, i64 64, i32 0, metadata !60} ; [ DW_TAG_member ]
!638 = metadata !{i32 458765, metadata !634, metadata !"h_index", metadata !21, i32 875, i64 32, i64 32, i64 96, i32 0, metadata !60} ; [ DW_TAG_member ]
!639 = metadata !{i32 458798, i32 0, metadata !634, metadata !"ap_range_ref", metadata !"ap_range_ref", metadata !"", metadata !21, i32 878, metadata !640, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!640 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !641, i32 0, null} ; [ DW_TAG_subroutine_type ]
!641 = metadata !{null, metadata !642, metadata !643}
!642 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !634} ; [ DW_TAG_pointer_type ]
!643 = metadata !{i32 458768, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !644} ; [ DW_TAG_reference_type ]
!644 = metadata !{i32 458790, metadata !3, metadata !"", metadata !3, i32 0, i64 128, i64 64, i64 0, i32 0, metadata !634} ; [ DW_TAG_const_type ]
!645 = metadata !{i32 458798, i32 0, metadata !634, metadata !"ap_range_ref", metadata !"ap_range_ref", metadata !"", metadata !21, i32 881, metadata !646, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!646 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !647, i32 0, null} ; [ DW_TAG_subroutine_type ]
!647 = metadata !{null, metadata !642, metadata !648, metadata !60, metadata !60}
!648 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !472} ; [ DW_TAG_pointer_type ]
!649 = metadata !{i32 458798, i32 0, metadata !634, metadata !"operator ap_int_base<2, false, true>", metadata !"operator ap_int_base<2, false, true>", metadata !"_ZNK12ap_range_refILi2ELb0EEcv11ap_int_baseILi2ELb0ELb1EEEv", metadata !21, i32 886, metadata !650, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!650 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !651, i32 0, null} ; [ DW_TAG_subroutine_type ]
!651 = metadata !{metadata !472, metadata !652}
!652 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !644} ; [ DW_TAG_pointer_type ]
!653 = metadata !{i32 458798, i32 0, metadata !634, metadata !"operator long long unsigned int", metadata !"operator long long unsigned int", metadata !"_ZNK12ap_range_refILi2ELb0EEcvyEv", metadata !21, i32 892, metadata !654, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!654 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !655, i32 0, null} ; [ DW_TAG_subroutine_type ]
!655 = metadata !{metadata !80, metadata !652}
!656 = metadata !{i32 458798, i32 0, metadata !634, metadata !"operator=", metadata !"operator=", metadata !"_ZN12ap_range_refILi2ELb0EEaSEy", metadata !21, i32 896, metadata !657, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!657 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !658, i32 0, null} ; [ DW_TAG_subroutine_type ]
!658 = metadata !{metadata !659, metadata !642, metadata !80}
!659 = metadata !{i32 458768, metadata !3, metadata !"ap_range_ref<2,false>", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !634} ; [ DW_TAG_reference_type ]
!660 = metadata !{i32 458798, i32 0, metadata !634, metadata !"operator=", metadata !"operator=", metadata !"_ZN12ap_range_refILi2ELb0EEaSERKS0_", metadata !21, i32 914, metadata !661, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!661 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !662, i32 0, null} ; [ DW_TAG_subroutine_type ]
!662 = metadata !{metadata !659, metadata !642, metadata !643}
!663 = metadata !{i32 458798, i32 0, metadata !634, metadata !"operator,", metadata !"operator,", metadata !"_ZN12ap_range_refILi2ELb0EEcmER11ap_int_baseILi2ELb0ELb1EE", metadata !21, i32 969, metadata !664, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!664 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !665, i32 0, null} ; [ DW_TAG_subroutine_type ]
!665 = metadata !{metadata !666, metadata !642, metadata !551}
!666 = metadata !{i32 458771, metadata !3, metadata !"ap_concat_ref<2,ap_range_ref<2, false>,2,ap_int_base<2, false, true> >", metadata !21, i32 635, i64 0, i64 0, i64 0, i32 4, null, null, i32 0, null} ; [ DW_TAG_structure_type ]
!667 = metadata !{i32 458798, i32 0, metadata !634, metadata !"length", metadata !"length", metadata !"_ZNK12ap_range_refILi2ELb0EE6lengthEv", metadata !21, i32 1080, metadata !668, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!669 = metadata !{metadata !60, metadata !652}
!670 = metadata !{i32 458798, i32 0, metadata !634, metadata !"to_int", metadata !"to_int", metadata !"_ZNK12ap_range_refILi2ELb0EE6to_intEv", metadata !21, i32 1084, metadata !668, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!671 = metadata !{i32 458798, i32 0, metadata !634, metadata !"to_uint", metadata !"to_uint", metadata !"_ZNK12ap_range_refILi2ELb0EE7to_uintEv", metadata !21, i32 1087, metadata !672, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!673 = metadata !{metadata !64, metadata !652}
!674 = metadata !{i32 458798, i32 0, metadata !634, metadata !"to_long", metadata !"to_long", metadata !"_ZNK12ap_range_refILi2ELb0EE7to_longEv", metadata !21, i32 1090, metadata !675, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!676 = metadata !{metadata !68, metadata !652}
!677 = metadata !{i32 458798, i32 0, metadata !634, metadata !"to_ulong", metadata !"to_ulong", metadata !"_ZNK12ap_range_refILi2ELb0EE8to_ulongEv", metadata !21, i32 1093, metadata !678, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!679 = metadata !{metadata !72, metadata !652}
!680 = metadata !{i32 458798, i32 0, metadata !634, metadata !"to_int64", metadata !"to_int64", metadata !"_ZNK12ap_range_refILi2ELb0EE8to_int64Ev", metadata !21, i32 1096, metadata !681, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!682 = metadata !{metadata !157, metadata !652}
!683 = metadata !{i32 458798, i32 0, metadata !634, metadata !"to_uint64", metadata !"to_uint64", metadata !"_ZNK12ap_range_refILi2ELb0EE9to_uint64Ev", metadata !21, i32 1099, metadata !684, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!685 = metadata !{metadata !136, metadata !652}
!686 = metadata !{i32 458798, i32 0, metadata !634, metadata !"and_reduce", metadata !"and_reduce", metadata !"_ZNK12ap_range_refILi2ELb0EE10and_reduceEv", metadata !21, i32 1102, metadata !687, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!688 = metadata !{metadata !40, metadata !652}
!689 = metadata !{i32 458798, i32 0, metadata !634, metadata !"or_reduce", metadata !"or_reduce", metadata !"_ZNK12ap_range_refILi2ELb0EE9or_reduceEv", metadata !21, i32 1105, metadata !687, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!690 = metadata !{i32 458798, i32 0, metadata !634, metadata !"xor_reduce", metadata !"xor_reduce", metadata !"_ZNK12ap_range_refILi2ELb0EE10xor_reduceEv", metadata !21, i32 1108, metadata !687, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!691 = metadata !{i32 458798, i32 0, metadata !472, metadata !"operator()", metadata !"operator()", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EEclEii", metadata !21, i32 1889, metadata !632, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!692 = metadata !{i32 458798, i32 0, metadata !472, metadata !"range", metadata !"range", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE5rangeEii", metadata !21, i32 1895, metadata !693, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!694 = metadata !{metadata !634, metadata !570, metadata !60, metadata !60}
!695 = metadata !{i32 458798, i32 0, metadata !472, metadata !"operator()", metadata !"operator()", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EEclEii", metadata !21, i32 1901, metadata !693, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!696 = metadata !{i32 458798, i32 0, metadata !472, metadata !"operator[]", metadata !"operator[]", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EEixEi", metadata !21, i32 1920, metadata !697, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!697 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !698, i32 0, null} ; [ DW_TAG_subroutine_type ]
!698 = metadata !{metadata !699, metadata !486, metadata !60}
!699 = metadata !{i32 458771, metadata !3, metadata !"ap_bit_ref<2,false>", metadata !21, i32 1118, i64 0, i64 0, i64 0, i32 4, null, null, i32 0, null} ; [ DW_TAG_structure_type ]
!700 = metadata !{i32 458798, i32 0, metadata !472, metadata !"operator[]", metadata !"operator[]", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EEixEi", metadata !21, i32 1934, metadata !607, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!701 = metadata !{i32 458798, i32 0, metadata !472, metadata !"bit", metadata !"bit", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE3bitEi", metadata !21, i32 1948, metadata !697, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!702 = metadata !{i32 458798, i32 0, metadata !472, metadata !"bit", metadata !"bit", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE3bitEi", metadata !21, i32 1962, metadata !607, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!703 = metadata !{i32 458798, i32 0, metadata !472, metadata !"and_reduce", metadata !"and_reduce", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE10and_reduceEv", metadata !21, i32 2142, metadata !704, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!704 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !705, i32 0, null} ; [ DW_TAG_subroutine_type ]
!705 = metadata !{metadata !40, metadata !486}
!706 = metadata !{i32 458798, i32 0, metadata !472, metadata !"nand_reduce", metadata !"nand_reduce", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE11nand_reduceEv", metadata !21, i32 2145, metadata !704, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!707 = metadata !{i32 458798, i32 0, metadata !472, metadata !"or_reduce", metadata !"or_reduce", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE9or_reduceEv", metadata !21, i32 2148, metadata !704, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!708 = metadata !{i32 458798, i32 0, metadata !472, metadata !"nor_reduce", metadata !"nor_reduce", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE10nor_reduceEv", metadata !21, i32 2151, metadata !704, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!709 = metadata !{i32 458798, i32 0, metadata !472, metadata !"xor_reduce", metadata !"xor_reduce", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE10xor_reduceEv", metadata !21, i32 2154, metadata !704, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!710 = metadata !{i32 458798, i32 0, metadata !472, metadata !"xnor_reduce", metadata !"xnor_reduce", metadata !"_ZN11ap_int_baseILi2ELb0ELb1EE11xnor_reduceEv", metadata !21, i32 2157, metadata !704, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!711 = metadata !{i32 458798, i32 0, metadata !472, metadata !"and_reduce", metadata !"and_reduce", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE10and_reduceEv", metadata !21, i32 2161, metadata !572, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!712 = metadata !{i32 458798, i32 0, metadata !472, metadata !"nand_reduce", metadata !"nand_reduce", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE11nand_reduceEv", metadata !21, i32 2164, metadata !572, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!713 = metadata !{i32 458798, i32 0, metadata !472, metadata !"or_reduce", metadata !"or_reduce", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE9or_reduceEv", metadata !21, i32 2167, metadata !572, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!714 = metadata !{i32 458798, i32 0, metadata !472, metadata !"nor_reduce", metadata !"nor_reduce", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE10nor_reduceEv", metadata !21, i32 2170, metadata !572, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!715 = metadata !{i32 458798, i32 0, metadata !472, metadata !"xor_reduce", metadata !"xor_reduce", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE10xor_reduceEv", metadata !21, i32 2173, metadata !572, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!716 = metadata !{i32 458798, i32 0, metadata !472, metadata !"xnor_reduce", metadata !"xnor_reduce", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE11xnor_reduceEv", metadata !21, i32 2176, metadata !572, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!717 = metadata !{i32 458798, i32 0, metadata !472, metadata !"to_string", metadata !"to_string", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE9to_stringEPci8BaseModeb", metadata !21, i32 2183, metadata !718, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!718 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !719, i32 0, null} ; [ DW_TAG_subroutine_type ]
!719 = metadata !{null, metadata !570, metadata !233, metadata !60, metadata !234, metadata !40}
!720 = metadata !{i32 458798, i32 0, metadata !472, metadata !"to_string", metadata !"to_string", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE9to_stringE8BaseModeb", metadata !21, i32 2210, metadata !721, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!721 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !722, i32 0, null} ; [ DW_TAG_subroutine_type ]
!722 = metadata !{metadata !233, metadata !570, metadata !234, metadata !40}
!723 = metadata !{i32 458798, i32 0, metadata !472, metadata !"to_string", metadata !"to_string", metadata !"_ZNK11ap_int_baseILi2ELb0ELb1EE9to_stringEab", metadata !21, i32 2214, metadata !724, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!724 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !725, i32 0, null} ; [ DW_TAG_subroutine_type ]
!725 = metadata !{metadata !233, metadata !570, metadata !44, metadata !40}
!726 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 137, metadata !727, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!729 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !469} ; [ DW_TAG_pointer_type ]
!730 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 199, metadata !731, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!731 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !732, i32 0, null} ; [ DW_TAG_subroutine_type ]
!732 = metadata !{null, metadata !729, metadata !40}
!733 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 200, metadata !734, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!734 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !735, i32 0, null} ; [ DW_TAG_subroutine_type ]
!735 = metadata !{null, metadata !729, metadata !44}
!736 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 201, metadata !737, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!738 = metadata !{null, metadata !729, metadata !48}
!739 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 202, metadata !740, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!740 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !741, i32 0, null} ; [ DW_TAG_subroutine_type ]
!741 = metadata !{null, metadata !729, metadata !52}
!742 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 203, metadata !743, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!744 = metadata !{null, metadata !729, metadata !56}
!745 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 204, metadata !746, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!747 = metadata !{null, metadata !729, metadata !60}
!748 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 205, metadata !749, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!749 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !750, i32 0, null} ; [ DW_TAG_subroutine_type ]
!750 = metadata !{null, metadata !729, metadata !64}
!751 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 206, metadata !752, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!752 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !753, i32 0, null} ; [ DW_TAG_subroutine_type ]
!753 = metadata !{null, metadata !729, metadata !68}
!754 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 207, metadata !755, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!756 = metadata !{null, metadata !729, metadata !72}
!757 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 208, metadata !758, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!759 = metadata !{null, metadata !729, metadata !80}
!760 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 209, metadata !761, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!762 = metadata !{null, metadata !729, metadata !76}
!763 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 210, metadata !764, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!765 = metadata !{null, metadata !729, metadata !84}
!766 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 211, metadata !767, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!768 = metadata !{null, metadata !729, metadata !88}
!769 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 213, metadata !770, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!771 = metadata !{null, metadata !729, metadata !92}
!772 = metadata !{i32 458798, i32 0, metadata !469, metadata !"ap_uint", metadata !"ap_uint", metadata !"", metadata !17, i32 214, metadata !773, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!773 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !774, i32 0, null} ; [ DW_TAG_subroutine_type ]
!774 = metadata !{null, metadata !729, metadata !92, metadata !44}
!775 = metadata !{i32 458798, i32 0, metadata !469, metadata !"operator=", metadata !"operator=", metadata !"_ZNV7ap_uintILi2EEaSERKS0_", metadata !17, i32 217, metadata !776, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!778 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !779} ; [ DW_TAG_pointer_type ]
!779 = metadata !{i32 458805, metadata !3, metadata !"", metadata !3, i32 0, i64 8, i64 8, i64 0, i32 0, metadata !469} ; [ DW_TAG_volatile_type ]
!780 = metadata !{i32 458768, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !781} ; [ DW_TAG_reference_type ]
!781 = metadata !{i32 458790, metadata !3, metadata !"", metadata !3, i32 0, i64 8, i64 8, i64 0, i32 0, metadata !469} ; [ DW_TAG_const_type ]
!782 = metadata !{i32 458798, i32 0, metadata !469, metadata !"operator=", metadata !"operator=", metadata !"_ZNV7ap_uintILi2EEaSERVKS0_", metadata !17, i32 221, metadata !783, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!783 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !784, i32 0, null} ; [ DW_TAG_subroutine_type ]
!784 = metadata !{null, metadata !778, metadata !785}
!785 = metadata !{i32 458768, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !786} ; [ DW_TAG_reference_type ]
!786 = metadata !{i32 458790, metadata !3, metadata !"", metadata !3, i32 0, i64 8, i64 8, i64 0, i32 0, metadata !779} ; [ DW_TAG_const_type ]
!787 = metadata !{i32 458798, i32 0, metadata !469, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi2EEaSERVKS0_", metadata !17, i32 225, metadata !788, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!788 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !789, i32 0, null} ; [ DW_TAG_subroutine_type ]
!789 = metadata !{metadata !790, metadata !729, metadata !785}
!790 = metadata !{i32 458768, metadata !3, metadata !"ap_uint<2>", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !469} ; [ DW_TAG_reference_type ]
!791 = metadata !{i32 458798, i32 0, metadata !469, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi2EEaSERKS0_", metadata !17, i32 230, metadata !792, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!793 = metadata !{metadata !790, metadata !729, metadata !780}
!794 = metadata !{i32 458798, i32 0, metadata !466, metadata !"stream", metadata !"stream", metadata !"", metadata !12, i32 37, metadata !795, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!795 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !796, i32 0, null} ; [ DW_TAG_subroutine_type ]
!796 = metadata !{null, metadata !797}
!797 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !466} ; [ DW_TAG_pointer_type ]
!798 = metadata !{i32 458798, i32 0, metadata !466, metadata !"stream", metadata !"stream", metadata !"", metadata !12, i32 40, metadata !799, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!800 = metadata !{null, metadata !797, metadata !92}
!801 = metadata !{i32 458798, i32 0, metadata !466, metadata !"stream", metadata !"stream", metadata !"", metadata !12, i32 45, metadata !802, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!802 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !803, i32 0, null} ; [ DW_TAG_subroutine_type ]
!803 = metadata !{null, metadata !797, metadata !804}
!804 = metadata !{i32 458768, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !805} ; [ DW_TAG_reference_type ]
!805 = metadata !{i32 458790, metadata !11, metadata !"", metadata !3, i32 0, i64 8, i64 8, i64 0, i32 0, metadata !466} ; [ DW_TAG_const_type ]
!806 = metadata !{i32 458798, i32 0, metadata !466, metadata !"operator=", metadata !"operator=", metadata !"_ZN3hls6streamI7ap_uintILi2EEEaSERKS3_", metadata !12, i32 48, metadata !807, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!807 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !808, i32 0, null} ; [ DW_TAG_subroutine_type ]
!808 = metadata !{metadata !809, metadata !797, metadata !804}
!809 = metadata !{i32 458768, metadata !3, metadata !"hlsstream<ap_uint<2> >", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !466} ; [ DW_TAG_reference_type ]
!810 = metadata !{i32 458798, i32 0, metadata !466, metadata !"operator>>", metadata !"operator>>", metadata !"_ZN3hls6streamI7ap_uintILi2EEErsERS2_", metadata !12, i32 55, metadata !811, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!811 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !812, i32 0, null} ; [ DW_TAG_subroutine_type ]
!812 = metadata !{null, metadata !797, metadata !790}
!813 = metadata !{i32 458798, i32 0, metadata !466, metadata !"operator<<", metadata !"operator<<", metadata !"_ZN3hls6streamI7ap_uintILi2EEElsERKS2_", metadata !12, i32 59, metadata !814, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!814 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !815, i32 0, null} ; [ DW_TAG_subroutine_type ]
!815 = metadata !{null, metadata !797, metadata !780}
!816 = metadata !{i32 458798, i32 0, metadata !466, metadata !"empty", metadata !"empty", metadata !"_ZNK3hls6streamI7ap_uintILi2EEE5emptyEv", metadata !12, i32 66, metadata !817, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!817 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !818, i32 0, null} ; [ DW_TAG_subroutine_type ]
!818 = metadata !{metadata !40, metadata !819}
!819 = metadata !{i32 458767, metadata !3, metadata !"", metadata !3, i32 0, i64 64, i64 64, i64 0, i32 64, metadata !805} ; [ DW_TAG_pointer_type ]
!820 = metadata !{i32 458798, i32 0, metadata !466, metadata !"full", metadata !"full", metadata !"_ZNK3hls6streamI7ap_uintILi2EEE4fullEv", metadata !12, i32 71, metadata !817, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!821 = metadata !{i32 458798, i32 0, metadata !466, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI7ap_uintILi2EEE4readERS2_", metadata !12, i32 77, metadata !811, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!822 = metadata !{i32 458798, i32 0, metadata !466, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI7ap_uintILi2EEE4readEv", metadata !12, i32 83, metadata !823, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!824 = metadata !{metadata !469, metadata !797}
!825 = metadata !{i32 458798, i32 0, metadata !466, metadata !"read_nb", metadata !"read_nb", metadata !"_ZN3hls6streamI7ap_uintILi2EEE7read_nbERS2_", metadata !12, i32 90, metadata !826, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!827 = metadata !{metadata !40, metadata !797, metadata !790}
!828 = metadata !{i32 458798, i32 0, metadata !466, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI7ap_uintILi2EEE5writeERKS2_", metadata !12, i32 98, metadata !814, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!829 = metadata !{i32 458798, i32 0, metadata !466, metadata !"write_nb", metadata !"write_nb", metadata !"_ZN3hls6streamI7ap_uintILi2EEE8write_nbERKS2_", metadata !12, i32 104, metadata !830, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!830 = metadata !{i32 458773, metadata !3, metadata !"", metadata !3, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !831, i32 0, null} ; [ DW_TAG_subroutine_type ]
!831 = metadata !{metadata !40, metadata !797, metadata !780}
!832 = metadata !{i32 458772, metadata !3, metadata !"ap_uint<2>", metadata !17, i32 134, i64 8, i64 8, i64 0, i32 0, null, metadata !833, i32 0, null} ; [ DW_TAG_structure_field_type ]
!833 = metadata !{metadata !834}
!834 = metadata !{i32 458772, metadata !3, metadata !"ap_int_base<2,false,true>", metadata !21, i32 599, i64 8, i64 8, i64 0, i32 0, null, metadata !835, i32 0, null} ; [ DW_TAG_structure_field_type ]
!835 = metadata !{metadata !836}
!836 = metadata !{i32 458772, metadata !3, metadata !"ssdm_int<2,false>", metadata !25, i32 4, i64 8, i64 8, i64 0, i32 0, null, metadata !837, i32 0, null} ; [ DW_TAG_structure_field_type ]
!837 = metadata !{metadata !477}
