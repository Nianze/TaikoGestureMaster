set moduleName set_color
set isCombinational 0
set isDatapathOnly 0
set isPipelined 0
set pipeline_type none
set isOneStateSeq 0
set C_modelName set_color
...
set C_modelArgList { 
	...
	{ gesture_V_V int 2 regular {fifo 0 volatile}  }
}
...
set portList { 
	...
	{ gesture_V_V_dout sc_in sc_lv 2 signal 6 } 
	{ gesture_V_V_empty_n sc_in sc_logic 1 signal 6 } 
	{ gesture_V_V_read sc_out sc_logic 1 signal 6 } 
}
...
set Spec2ImplPortList { 
	...
	gesture_V_V { ap_fifo {  { gesture_V_V_dout fifo_data 0 2 }  { gesture_V_V_empty_n fifo_status 0 1 }  { gesture_V_V_read fifo_update 1 1 } } }
}
