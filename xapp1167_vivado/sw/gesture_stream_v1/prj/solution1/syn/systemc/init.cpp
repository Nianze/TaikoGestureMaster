...
init::init(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_tmp_31_fu_33_p1);
    sensitive << ( p_cols );
    ...
    sc_trace(mVcdFile, tmp_31_fu_33_p1, "tmp_31_fu_33_p1");
...
void init::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
             !ap_sig_bdd_31.read())) {
            ap_return_2_preg = tmp_31_fu_33_p1.read();
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
             !ap_sig_bdd_31.read())) {
            ap_return_3_preg = tmp_31_fu_33_p1.read();
        }
    }
}
...
void init::thread_ap_return_2() {
    if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
         !ap_sig_bdd_31.read())) {
        ap_return_2 = tmp_31_fu_33_p1.read();
    } else {
...
void init::thread_ap_return_3() {
    if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
         !ap_sig_bdd_31.read())) {
        ap_return_3 = tmp_31_fu_33_p1.read();
    } else {
...
void init::thread_tmp_31_fu_33_p1() {
    tmp_31_fu_33_p1 = p_cols.read().range(12-1, 0);
}
