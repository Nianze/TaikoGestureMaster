...
#ifndef _median_filter_lineBuffer_val_0_H_
#define _median_filter_lineBuffer_val_0_H_
...
struct median_filter_lineBuffer_val_0_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(median_filter_lineBuffer_val_0_core);
    median_filter_lineBuffer_val_0_core(sc_core::sc_module_name) {
    ...
    ~median_filter_lineBuffer_val_0_core() {
        delete [] mem;
    }
...
SC_MODULE( median_filter_lineBuffer_val_0 )
{
    ...
    SC_CTOR( median_filter_lineBuffer_val_0 ) {
        meminst = new median_filter_lineBuffer_val_0_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    median_filter_lineBuffer_val_0_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
...
#endif //_median_filter_lineBuffer_val_0_H_
