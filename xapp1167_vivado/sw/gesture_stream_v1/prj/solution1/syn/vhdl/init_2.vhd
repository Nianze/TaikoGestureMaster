...
architecture behav of init_2 is 
    ...
    signal tmp_34_fu_33_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_29))) then 
                    ap_return_1_preg <= tmp_34_fu_33_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_1_assign_proc : process(ap_CS_fsm, ap_sig_bdd_29, tmp_34_fu_33_p1, ap_return_1_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_29))) then 
            ap_return_1 <= tmp_34_fu_33_p1;
        else 
    ...
    tmp_34_fu_33_p1 <= p_cols(12 - 1 downto 0);
