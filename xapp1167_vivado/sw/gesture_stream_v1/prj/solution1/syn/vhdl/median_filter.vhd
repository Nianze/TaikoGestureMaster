...
architecture behav of median_filter is 
    ...
    signal tmp_30_cast_fu_704_p1 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    tmp_30_cast_fu_704_p1 <= std_logic_vector(resize(unsigned(t_V_reg_605),13));
    tmp_3_fu_708_p2 <= "1" when (unsigned(tmp_30_cast_fu_704_p1) < unsigned(op2_assign_1_reg_3717)) else "0";
    ...
    tmp_8_fu_745_p2 <= "1" when (unsigned(tmp_30_cast_fu_704_p1) > unsigned(op2_addr_i_i1_reg_3727)) else "0";
