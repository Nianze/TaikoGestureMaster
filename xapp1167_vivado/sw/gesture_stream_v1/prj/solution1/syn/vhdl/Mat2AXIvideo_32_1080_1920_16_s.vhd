...
architecture behav of Mat2AXIvideo_32_1080_1920_16_s is 
    ...
    signal t_V_7_reg_174 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    -- t_V_7_reg_174 assign process. --
    t_V_7_reg_174_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    exitcond2_fu_212_p2 <= "1" when (t_V_7_reg_174 = img_cols_V_read) else "0";
    ...
    j_V_fu_217_p2 <= std_logic_vector(unsigned(t_V_7_reg_174) + unsigned(ap_const_lv12_1));
    ...
    tmp_cast_fu_223_p1 <= std_logic_vector(resize(unsigned(t_V_7_reg_174),13));
end behav;
