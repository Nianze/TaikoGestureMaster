...
const sc_lv<12> init_5::ap_const_lv12_0 = "000000000000";
...
void init_5::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
             !ap_sig_bdd_29.read())) {
            ap_return_1_preg = tmp_167_fu_33_p1.read();
        }
    }
}
...
void init_5::thread_ap_return_0() {
    if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
         !ap_sig_bdd_29.read())) {
...
void init_5::thread_ap_return_1() {
    if ((esl_seteq<1,1,1>(ap_ST_st1_fsm_0, ap_CS_fsm.read()) && 
         !ap_sig_bdd_29.read())) {
        ap_return_1 = tmp_167_fu_33_p1.read();
    } else {
        ap_return_1 = ap_return_1_preg.read();
    }
}

void init_5::thread_ap_sig_bdd_29() {
    ap_sig_bdd_29 = (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1));
}

void init_5::thread_tmp_167_fu_33_p1() {
    tmp_167_fu_33_p1 = p_cols.read().range(12-1, 0);
}

void init_5::thread_tmp_fu_29_p1() {
