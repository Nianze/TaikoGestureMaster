...
#ifndef __image_filter_mul_8ns_8s_16_3__HH__
#define __image_filter_mul_8ns_8s_16_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mul_8ns_8s_16_3) {
    ...
    SC_CTOR(image_filter_mul_8ns_8s_16_3):  ACMP_mul_us_U ("ACMP_mul_us_U") {
