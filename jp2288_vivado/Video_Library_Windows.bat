@echo off
set VIVADO_HLS_HOME=C:\Xilinx\Vivado_HLS\2013.2
set VIVADO_HOME=C:\Xilinx\Vivado\2013.2

call %VIVADO_HOME%\settings64.bat
PATH=%VIVADO_HLS_HOME%\bin;%VIVADO_HLS_HOME%\msys\bin;%PATH%
PATH=%PATH%;%VIVADO_HLS_HOME%\Win_x86\tools\opencv
...
echo =================================================
echo == Note:  Vivado HLS 2013.2 default location:
echo ==     C:\Xilinx\Vivado_HLS\2013.2
echo ==        Vivado 2013.2 default location:
echo ==     C:\Xilinx\Vivado\2013.2
